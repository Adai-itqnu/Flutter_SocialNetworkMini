...
/// Widget carousel hiển thị nhiều ảnh của bài viết
/// Có indicator số trang và dot indicators
class PostImageCarousel extends StatefulWidget {
  final List<String> imageUrls;
  final double aspectRatio;

  const PostImageCarousel({super.key, required this.imageUrls, this.aspectRatio = 1.0});
  ...
  Widget build(BuildContext context) {
    ...
    return AspectRatio(
      ...
      child: Stack(children: [
        // PageView cho ảnh (hỗ trợ chuột kéo trên web)
        ScrollConfiguration(
        ...
        if (imageCount > 1)
          Positioned(
            ...
            child: Container(
              ...
              child: Text('${_currentImageIndex + 1}/$imageCount', style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w500)),
            ),
          ),

        // Dot indicators (giữa dưới)
        if (imageCount > 1)
          Positioned(
            bottom: 12,
            left: 0,
              ...
              children: List.generate(imageCount, (index) {
                ...
                return AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isActive ? Colors.blue : Colors.white.withValues(alpha: 0.7),
