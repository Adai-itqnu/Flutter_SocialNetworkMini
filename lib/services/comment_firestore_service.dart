...
/// Service xử lý Firestore cho Comment
/// Bao gồm: thêm, xóa, like comment
class CommentFirestoreService {
  ...
  // Lấy stream comments của bài viết
  Stream<List<CommentModel>> getComments(String postId) {
    return _firestore.collection('comments').where('postId', isEqualTo: postId).snapshots().map((snapshot) {
      ...
      comments.sort((a, b) => a.createdAt.compareTo(b.createdAt)); // Sort client-side
      return comments;
    });
  }
  ...
  // Lấy stream replies của comment
